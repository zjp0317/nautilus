...
//{
static int
handle_streamcluster1 (char * buf, void * priv)
{
    int numt = nautilus_info.sys.num_cpus;
    startproc = 0;
...
static struct shell_cmd_impl streamcluster1_impl = {
    .cmd      = "streamcluster1",
    .help_str = "streamcluster1", 
    .handler  = handle_streamcluster1,
};
nk_register_shell_cmd(streamcluster1_impl);
