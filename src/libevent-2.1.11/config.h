...
/* Define to 1 if you have the <nautilus/naut_types.h> header file. */
...
/* Define to `int' if <nautilus/naut_types.h> does not define. */
#undef pid_t

/* Define to `unsigned int' if <nautilus/naut_types.h> does not define. */
#undef size_t
